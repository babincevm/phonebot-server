...
const SurveySubgroupController = new SurveySubgroup({ model: models.SurveySubgroup });
...
const CardController = new Card({model: models.Card});
...
const ExerciseDirectionController = new ExerciseDirection({model: models.ExerciseDirection});
